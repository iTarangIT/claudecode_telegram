    ...
    dealer: [
        ...
        },
        {
            ...
            items: [
                ...
                { id: 'service', label: 'Service Management', icon: Wrench, href: '/dealer-portal/service' },
                { id: 'campaigns', label: 'Campaigns', icon: Megaphone, href: '/dealer-portal/campaigns/new' },
            ]
        }
    ],
    user: [
